    ...
    export default {
        ...
        methods: {
            ...
            getSelectDate(){
                ...
                var defaultDateAry=defaultDate.split('-');
                var defaultYear=defaultDateAry[0];
                var defaultMonth=defaultDateAry[1];
                var defaultDay=defaultDateAry[2];

                this.year=this.tmpYear=this.tmpStartYear=this.tmpEndYear=Number(defaultYear);
                this.month=this.tmpMonth=this.tmpStartMonth=this.tmpEndMonth=Number(defaultMonth)-1;
                this.date=this.tmpStartDate=this.tmpEndDate=Number(defaultDay);
            }
        },
        watch: {
            min (v) {
...
<style scoped lang='less'>
    *{
    ...
    .input{
        ...
        box-sizing: border-box;
        outline: none;
        background: url(../assets/images/canl.png) 80px center no-repeat;
    }
    .cancel-btn{
        height: 14px;
        width: 14px;
    ...
    .date-list{
        ...
        li{
            ...
            .message{
                ...
                &.selected{
                    .bg{
                        background-color: rgb(87, 141, 237);
                    }
                    span{
                        color: #fff;
                    }
